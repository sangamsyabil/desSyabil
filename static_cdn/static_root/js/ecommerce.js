  ...
  productForm.submit(function(event){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if (data.added){
            submitSpan.html("<div class='btn-group'> <a class='btn btn-link item-already-in-cart' href='/cart/'>In Cart</a> \n" +
                "<button type='submit' class='btn btn-link remove-item-from-cart'>Remove?</button></div>")

          } else {
            submitSpan.html("<button type='submit' class='btn btn-success item-add-to-cart''>Add to Cart</button>")
           }
